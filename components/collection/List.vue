<template>
  ...
  >
    ...
    >
      ...
      >
        <!-- @click="prefillData(formInput)" -->
        <section>
          <h5 class="font-[500] text-md mb-2">{{ input.dns }}</h5>
          <span class="text-gray-600">{{ input.user_domain }} - </span>
          <!-- <span class="text-gray-600">{{ formInput.text }}</span> -->
        </section>
      ...
      <!-- <div v-if="formInputs && formInputs.length == 0">
        <span
