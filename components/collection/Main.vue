<template>
  ...
  <div v-else>
    ...
    >
      ...
      <CollectionAdd
        v-show="addTemplate || templates.length"
        :key="render"
      ...
      <p
        ...
        class="mt-[150px] ml-4 justify-center text-xl text-b ml-[400px]"
      >
        No templates found
      </p>
      <!-- End of RHS section -->
...
const props = defineProps({
  url: {
    type: String,
    default: "https://v1-orm-lib.mars.hipso.cc/email-templates/",
  },
  isActive: {
    type: String,
    default: "1",
