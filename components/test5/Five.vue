  ...
  <div class="bg-white py-24 sm:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-4xl text-center">
        ...
        >
          One Pricing for
          <span class="bg-yellow-300 px-2 py-1">50 Apps</span> at just ₹999
        </p>
      </div>
      <p
        class="mx-auto mt-6 max-w-2xl text-center text-md leading-8 text-gray-600"
      >
        ...
        >
          ...
          <div>
            <a
              ...
              >Sign Up
              <br />
              <span class="text-xs text-gray-400">14 day trial</span>
            </a>
          </div>
        </div>
      </div>
